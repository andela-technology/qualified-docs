<template>
    <svg :width="getWidth" :height="getHeight" x="0.0" y="0.0" viewBox="0 0 231 157" xmlns="http://www.w3.org/2000/svg" class="qualified-logo-svg">
        <g fill="currentColor" fill-rule="evenodd">
            <g transform="translate(196.125)">
                <ellipse cx="16.938" cy="16.938" rx="16.938" ry="16.938"/>
                <ellipse opacity=".8" cx="16.938" cy="81.124" rx="16.938" ry="16.938"/>
                <ellipse opacity=".4" cx="16.938" cy="139.962" rx="16.938" ry="16.938"/>
            </g>
