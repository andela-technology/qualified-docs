...
export function isEmbedded() {
  if (_embedded === null) {
    ...
    if (process.isClient) {
      ...
      const matcher = (window.location.search || "").match(
        /\bembedded=(true|false)\b/,
      );
  ...
  return pages
    .map((page) => {
      ...
      return {
        ...
        active:
          current ||
          currentPage.path.indexOf(
            directory.length > 1 ? directory : page.path,
          ) === 0,
        pages: [],
        ...page,
      };
