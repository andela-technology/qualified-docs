...
Since Python 3.7, we have presets for different kinds of challenges. Use the Run Configuration menu in [project code challenge](/kb/hire/challenges/multi-file-code) mode to select a preset.
...
- [python/unittest](/kb/languages/python/unittest)
- [python/cw-2](/kb/languages/python/cw-2)
