...
* [Bulk Editing](/reference/candidates/bulk-editing)
...
:::tip
You can use [bulk editing](/reference/candidates/bulk-editing) to manage multiple candidates at once.
:::
...
For complete technical details on each solution, including code playback & test suite results, [click on **SOLUTION DETAILS** to open up the complete history for this solution.](/reference/candidates/solutions)

* [Solutions](/reference/candidates/solutions)
