...
## A note on Jest's exit code behavior in [Project Code Challenges](/reference/challenges/multi-file-code)
...
Visit the [project code challenges page](/reference/challenges/multi-file-code) to learn more about selecting which files to send to the code runner on submission.
